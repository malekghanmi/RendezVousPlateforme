...
<head>
    <meta charset="UTF-8">
    <title>Service Ajouté - Smile Everyday</title>
...
@keyframes imageAnimation { 
    ...
    100% { 
        ...
        .nav-links a { 
            ...
            transition: 0.3s; text-shadow: 1px 1px 2px black; display: flex; align-items: center; gap: 5px;
        }
        ...
        .btn-primary { 
            padding: 12px 30px; background: linear-gradient(45deg, #3498db, #2980b9); color: white; border: none; border-radius: 50px; cursor: pointer; font-weight: bold; font-size: 16px; transition: 0.3s;
        }
        .btn-primary:hover { transform: scale(1.05); background: linear-gradient(45deg, #2980b9, #1f618d); }
        ...
        .btn-outline:hover { border-color: #3498db; color: #3498db; background: rgba(52, 152, 219, 0.1); }
...
<body>
    ...
    <div class="header">
        ...
        <ul class="nav-links">
            ...
            <li><a href="Service.jsp" class="active">➕ Nouveau Service</a></li>
    ...
    <div class="glass-card">
        ...
        <h1 style="color: #3498db;">Service Ajouté !</h1>

        <div class="message-box">
            Le nouveau service médical a été ajouté au catalogue.<br>
            Il est désormais visible pour les patients.
        </div>

        <div class="btn-row">
            <button onclick="window.location.href='Controleur?action=espaceDentiste'" class="btn-primary">Retour Tableau de Bord</button>
            <button onclick="window.location.href='Service.jsp'" class="btn-outline">Ajouter un autre</button>
        </div>
    </div>
